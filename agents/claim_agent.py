...
5. 계층 구조 반영 규칙:
   - parent_id가 null인 Component만 독립항의 최상위 구성요소로 나열하라.
   - parent_id가 있는 Component는 해당 상위 구성요소를 설명하는 종속항에서 한정하라.
     예: COMP_002(parent_id=COMP_001) → "상기 [COMP_001 name]은 [COMP_002 name]을 포함하는"
"""
