# 도면 생성 리포트 - 1020210162275

- 생성일시: 2026-05-11 16:35:25
- 총 도면 수: 2
- 평균 품질 점수: 85.0
- 통과 기준: 75점 이상
- 통과/검토필요: 2/0
...
|---|---|---|---:|---|---:|---|---|---|---|
| 도 1 | 본 발명의 일 실시예에 따른 가상 모델하우스 시뮬레이션 서비스 제공 서버를 포함하는 시스템도이다 | block_diagram | 85 | B | 1회 | 1020210162275_fig_1.mmd | - | - | - |
| 도 3 | 본 발명의 일 실시예에 따른 가상 모델하우스 시뮬레이션 서비스 제공 서버 동작 방법의 일 실시예를 도 | flowchart | 85 | B | 1회 | 1020210162275_fig_3.mmd | - | - | - |
