...
|---|---|---|---:|---|---|---|---|
| 도 1 | 일 실시예에 따른 사용자 입력에 기반한 문장을 제공하는 장치를 설명하기 위한 블록도이다 | block_diagram | 100 | A | 1020170144234_fig_1.svg | 1020170144234_fig_1.png | 1020170144234_fig_1_layout.json |
| 도 10 | 일 실시예에 따른 사용자 입력에 기반한 문장을 제공하는 방법을 나타내는 흐름도이다 | flowchart | 100 | A | 1020170144234_fig_10.svg | 1020170144234_fig_10.png | 1020170144234_fig_10_layout.json |
