# 도면 생성 리포트 - 1020200142527

- 생성일시: 2026-05-11 16:37:47
- 총 도면 수: 2
- 평균 품질 점수: 85.0
- 통과 기준: 75점 이상
- 통과/검토필요: 2/0
...
|---|---|---|---:|---|---:|---|---|---|---|
| 도 1 | 본 개시의 예시적 실시 예에 따른 컴퓨팅 시스템을 설명하기 위한 도면이다 | block_diagram | 85 | B | 1회 | 1020200142527_fig_1.mmd | - | - | - |
| 도 4 | 본 개시의 예시적 실시 예에 따른 컴퓨팅 시스템의 동작 방법을 설명하는 도면이다 | flowchart | 85 | B | 1회 | 1020200142527_fig_4.mmd | - | - | - |
