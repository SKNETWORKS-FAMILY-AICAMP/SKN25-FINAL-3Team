...
async def generate_claims_api(request, project_id):
    ...
    async def event_stream():
        fastapi_url = "http://fastapi-worker:8001/api/v1/generate-claims"
...
def generate_drawings_api(request, project_id):
    ...
    fastapi_url = "http://fastapi-worker:8001/api/v1/generate-drawings"
    payload = {
        "mock_input_data": mock_input_data,
...
def generate_specification_api(request, project_id):
    ...
    fastapi_url = "http://fastapi-worker:8001/api/v1/generate-specification"
