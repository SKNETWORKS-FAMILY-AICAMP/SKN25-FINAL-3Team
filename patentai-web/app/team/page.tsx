...
const members = [
  ...
  { num: '04', name: '팀원 4', role: 'Specification / Claims', desc: '청구항, 명세서 초안, 발명의 효과 및 구성요소 정리 기능을 담당합니다.', slug: null },
  { num: '05', name: '팀원 5', role: 'Drawing Agent', desc: '특허 도면 자동 생성, SVG/PNG 렌더링, 품질 검증 기능을 담당합니다.', slug: null },
  { num: '06', name: '팀원 6', role: 'Review / Integration', desc: '검토 에이전트, 전체 서비스 통합, 배포 및 발표 자료 정리를 담당합니다.', slug: null },
]
