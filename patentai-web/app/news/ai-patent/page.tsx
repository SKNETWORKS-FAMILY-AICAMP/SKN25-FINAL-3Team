...
const items = [
  { date: '2025.04', title: 'AI 생성물 특허 출원 급증', desc: '특허청, 생성형 AI 관련 특허 출원이 전년 대비 42% 증가했다고 발표. 출원 자동화 도구 수요도 함께 확대.', url: 'https://www.kipo.go.kr' },
  ...
  { date: '2025.01', title: 'LLM 기반 특허 명세서 자동화 연구', desc: '국내 연구기관이 GPT 기반 특허 명세서 자동 작성 시스템의 성능을 검증한 논문을 발표했습니다.', url: 'https://www.kipo.go.kr' },
  { date: '2024.12', title: 'AI 발명자 인정 논쟁 본격화', desc: '미국·유럽 특허청이 AI를 발명자로 인정할 수 없다고 결정한 가운데, 국내 특허청의 입장이 주목받고 있습니다.', url: 'https://www.kipo.go.kr' },
]
