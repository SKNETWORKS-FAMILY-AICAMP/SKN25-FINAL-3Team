...
const news = [
  {
    category: 'AI PATENT',
    date: '2025.04',
    title: 'AI 생성물 특허 출원 급증',
    desc: '특허청, 생성형 AI 관련 특허 출원이 전년 대비 42% 증가했다고 발표. 출원 자동화 도구 수요도 함께 확대.',
  ...
  },
  {
    category: 'PRIOR ART',
    date: '2025.03',
    title: 'KIPRIS 검색 고도화 업데이트',
    desc: '특허청 KIPRIS, 벡터 유사도 기반 선행기술 검색 기능 추가. 키워드 검색 대비 관련도 높은 결과 제공.',
  ...
  },
  {
    category: 'DRAWING',
    date: '2025.03',
    title: '특허 도면 자동 생성 기술 상용화',
    desc: '명세서 텍스트만으로 블록도·흐름도를 자동 생성하는 AI 도면 에이전트가 특허 실무에 본격 도입.',
  ...
  },
  {
    category: 'POLICY',
    date: '2025.02',
    title: '2025 지식재산 기본계획 발표',
    desc: '특허청, AI·바이오·반도체 분야 우선심사 확대 및 심사 처리 기간 단축 계획 발표. 스타트업 지원 강화.',
    img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&q=80',
    links: [
      { label: '특허청 정책 발표', url: 'https://www.kipo.go.kr/ko/kpoContentView.do?menuCd=SCD0200045' },
      { label: '지식재산 기본계획 전문', url: 'https://www.kipo.go.kr' },
    ],
  },
  {
    category: 'CLAIMS',
    date: '2025.01',
    title: 'LLM 기반 청구항 자동 작성 연구',
    desc: '국내 대학·연구기관이 발명 설명을 입력하면 독립항·종속항을 자동 구성하는 sLLM 모델을 공개.',
  ...
  },
  {
    category: 'IPC / CPC',
    date: '2024.12',
    title: 'WIPO IPC 2025년판 개정',
    desc: 'AI·양자컴퓨팅·지속가능에너지 분야 신규 IPC 코드 대거 추가. 국내 출원 분류 체계도 연동 업데이트 예정.',
  ...
  return (
    <div className="site">
      ...
      <div className="section">
        ...
        <div className="title">최신 특허 뉴스</div>
        <div className="sub">국내외 IP·AI 특허 동향을 정기적으로 업데이트합니다.</div>
            ...
            <div className="news-card" key={i}>
              ...
              <div className="news-body">
                ...
                <div className="news-links">
                  {item.links.map((link) => (
                    <a key={link.url} className="news-link" href={link.url} target="_blank" rel="noopener noreferrer">
                      {link.label}
                    </a>
                  ))}
                </div>
