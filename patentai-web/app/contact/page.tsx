  ...
  return (
    <div className="site">
      ...
      <div className="hero">
        ...
        <h1>상담 신청</h1>
        <p>발명 내용을 남겨주시면 PatentAI 팀이 검토 후 연락드립니다.</p>
      </div>
      ...
      <div className="section">
        <div className="contact-grid">
          ...
          <div className="contact-info-card">
            <div className="contact-info-title">문의하기</div>
            <div className="contact-info-line" />

            <div className="contact-info-item">
              <div>
                <strong>ADDRESS</strong>
                서울특별시 강남구 테헤란로<br />PatentAI 빌딩
              </div>
            </div>
            <div className="contact-info-item">
              <div>
            ...
            <div className="contact-hours">
              <strong style={{ color: '#C9A84C', fontSize: '0.72rem', letterSpacing: '0.1em' }}>운영 시간</strong><br />
              월–금 09:00 – 18:00<br />
              토·일·공휴일 휴무<br /><br />
              <span style={{ color: '#555577' }}>긴급 문의는 이메일로 접수해 주세요.</span>
            </div>
          </div>
          ...
          <div>
            {submitted ? (
              <div className="success-box">
                ...
                <div style={{ fontSize: '1.1rem', fontWeight: 700, marginBottom: '0.5rem' }}>상담 신청이 접수되었습니다.</div>
                <div style={{ fontSize: '0.9rem' }}>영업일 기준 1–2일 내 담당자가 연락드립니다.</div>
              </div>
            ) : (
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                  <label className="form-label">발명 내용 / 문의사항 *</label>
                  <textarea className="form-textarea" name="message" placeholder="발명하신 내용이나 궁금한 점을 자유롭게 적어주세요." value={form.message} onChange={handleChange} required />
                </div>
                <button className="form-submit" type="submit">상담 신청하기</button>
              </form>
            )}
          </div>
        </div>
